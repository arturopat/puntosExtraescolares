                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?php echo $nombres; ?></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label ">Apellidos</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $apellidos; ?></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?php echo $semestre; ?></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label ">Carrera</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $carrera; ?></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label ">Puntos</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $puntos; ?></div>
                                    </div>
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input type="text" disabled class="form-control" id="fullName" value="<?php echo $nombres; ?>">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Apellidos</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input type="text" disabled class="form-control" id="fullName" value="<?php echo $apellidos; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input type="text" disabled class="form-control" id="fullName" value="<?php echo $correo; ?>">
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Semestre</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="semestre" type="text" class="form-control" id="fullName" value="<?php echo $semestre; ?>">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Carrera</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input type="text" disabled class="form-control" id="fullName" value="<?php echo $carrera; ?>">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Puntos</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input type="text" disabled class="form-control" id="fullName" value="<?php echo $puntos; ?>">
                                            </div>
                                        </div>
