...
$sql = "SELECT nombre,correo,tipo_usuario FROM adminsresponsables WHERE id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $id_actividad);
$stmt->execute();
$stmt->bind_result($nombresa, $correoa, $tipo_usuarioa);
$stmt->fetch();
$stmt->close();
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if ($_POST) {
                                $sql =  "DELETE FROM `adminsresponsables` WHERE `adminsresponsables`.`id` = $id_actividad";
                            ...
                            <form method="post">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="name" value="<?php echo $nombresa; ?>" class="form-control" id="yourName" required>
                                    <div class="invalid-feedback">Please, enter your name!</div>
                                </div>


                                <div class="col-12">
                                    <label for="yourName" class="form-label">Correoa</label>
                                    <input type="email" name="email" class="form-control" value="<?php echo $correo; ?>" id="yourName" required>
                                    <div class="invalid-feedback">Please, enter your name!</div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="tipo_usuario" value="<?php echo $tipo_usuarioa; ?>" class="form-control" id="yourName" required>
                                </div>
                                ...
                                <div class="col-12">
                                    <br>
                                    <input type="submit" name="submit" value="Eliminar Usuario" class="btn btn-danger w-100">
                                </div>
